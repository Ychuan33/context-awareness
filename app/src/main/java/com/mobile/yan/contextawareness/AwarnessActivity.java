...
public class AwarnessActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, AdapterView.OnItemClickListener {
    ...
    private void createFence() {
        ...
        mFenceBroadcastReceiver = new AwarnessActivity.FenceBroadcastReceiver();
